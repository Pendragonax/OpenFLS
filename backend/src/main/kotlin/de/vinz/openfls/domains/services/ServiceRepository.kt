...
interface ServiceRepository : CrudRepository<Service, Long> {
    ...
    fun findProjectionsByInstitutionIdsAndStartAndEnd(
    ...
    fun findContingentEvaluationServiceProjectionByInstitutionIdsAndStartAndEnd(
        institutionId: Long,
        start: LocalDate,
        end: LocalDate
    ...
    fun findProjectionsByInstitutionIdsAndClientIdAndStartAndEnd(
        institutionIds: List<Long>,
        clientId: Long,
        start: LocalDate,
        end: LocalDate
    ...
    fun findByInstitutionIdAndClientIdAndStartAndEnd(
        institutionId: Long,
        clientId: Long,
        start: LocalDate,
        end: LocalDate
    ...
    fun findByClientAndStartAndEnd(
        @Param("clientId") clientId: Long,
        @Param("start") start: LocalDate,
        @Param("end") end: LocalDate
    ): List<Service>
    ...
    @Query(
        "SELECT u FROM Service u WHERE u.employee.id = :employeeId AND " +
                "u.client.id = :clientId AND " +
                "cast(u.start as LocalDate) = :date ORDER BY u.start ASC"
    )
    fun findByEmployeeAndClientAndDate(
        @Param("employeeId") employeeId: Long,
        @Param("clientId") clientId: Long,
        @Param("date") date: LocalDate
    ): List<Service>
    ...
    fun findByEmployeeAndStartEndDate(
        @Param("employeeId") employeeId: Long,
        @Param("start") start: LocalDate,
        @Param("end") end: LocalDate
    ): List<Service>
    ...
    fun findServiceByYearAndMonthAndHourTypeIdAndSponsorId(
        @Param("year") year: Int,
        @Param("month") month: Int,
        @Param("hourTypeId") hourTypeId: Long,
        @Param("sponsorId") sponsorId: Long
    ...
    fun findServiceByYearAndMonthAndHourTypeIdAndAreaId(
        @Param("year") year: Int,
        @Param("month") month: Int,
        @Param("hourTypeId") hourTypeId: Long,
        @Param("areaId") areaId: Long
    ...
    fun findServiceByYearAndMonthAndHourTypeId(
        @Param("year") year: Int,
        @Param("month") month: Int,
        @Param("hourTypeId") hourTypeId: Long
    ): List<Service>
    ...
    fun findServiceByYearByHourTypeIdAndAreaIdAndSponsorId(
        @Param("year") year: Int,
        @Param("hourTypeId") hourTypeId: Long,
        @Param("areaId") areaId: Long,
        @Param("sponsorId") sponsorId: Long
    ...
    fun findServiceByYearByHourTypeIdAndSponsorId(
        @Param("year") year: Int,
        @Param("hourTypeId") hourTypeId: Long,
        @Param("sponsorId") sponsorId: Long
    ): List<Service>
    ...
    fun findServiceByYearByHourTypeIdAndAreaId(
        @Param("year") year: Int,
        @Param("hourTypeId") hourTypeId: Long,
        @Param("areaId") areaId: Long
    ): List<Service>
    ...
    fun findServiceByYearByHourTypeId(
        @Param("year") year: Int,
        @Param("hourTypeId") hourTypeId: Long
    ): List<Service>
    ...
    @Query(
        "SELECT u FROM Service u WHERE u.assistancePlan.id = :assistancePlanId " +
                "AND (cast(u.start as LocalDate) > u.assistancePlan.end OR cast(u.start as LocalDate) < u.assistancePlan.start) " +
                "ORDER BY u.start ASC"
    )
    ...
    fun findByAssistancePlanAndNotBetweenStartAndEnd(
        @Param("assistancePlanId") assistancePlanId: Long,
        @Param("start") start: LocalDate,
        @Param("end") end: LocalDate
    ): List<ServiceProjection>
